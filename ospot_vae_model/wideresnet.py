...
class WideResNet(nn.Module):
    def __init__(self, num_input_channels=1, num_init_features=16, depth=28, width=2,
...
def get_wide_resnet(name, drop_rate, input_channels=1, small_input=False, data_parallel=True):
    """
