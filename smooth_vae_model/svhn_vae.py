...
class svhn_VAE(nn.Module):
    def __init__(self, img_size, latent_spec, temperature=.67, use_cuda=False):
        ...
        self.hidden_dim = 512  # Hidden dimension of linear layer
        self.reshape = (128, 4, 4)  # Shape required to start transpose convs
        ...
        self.features_to_hidden = nn.Sequential(
            nn.Linear(128 * 4 * 4, self.hidden_dim),
            nn.ReLU()
        )
        ...
        #     nn.Conv2d(128, 128, 3, stride=1, padding=1),
        #     nn.ReLU(),
        #     nn.ConvTranspose2d(128, 64, 3, stride=2, padding=1, dilation=1, output_padding=1),
        #     nn.ReLU(),
        #
